...
const Sidebar: React.FC<SidebarProps> = ({ toggleMenu, isMenuOpen }) => {
  return (
    <aside className={`
      ...
      w-20 lg:w-24 border-r-2 border-white/40 flex flex-col items-center
      hidden lg:flex
    `}>
        ...
        <div className="relative">
          {isMenuOpen ? (
            ...
            <div className="flex flex-col items-center justify-center group">
              ...
              <Menu className="w-10 h-10 hidden group-hover:block" />
            </div>
          )}
        </div>
      </button>
      
      {/* Vertical Branding Labels - Always visible and at full opacity */}
