          ...
          <div key={index} className="flex items-center space-x-12 px-12 group cursor-default">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex flex-col">
                <span className="text-white font-black text-[16px] tracking-[0.2em] leading-none uppercase">
                  {logo.name}
                </span>
                <span className="text-white/60 group-hover:text-white transition-colors duration-500 text-[8px] font-bold tracking-[0.3em] mt-1 uppercase">
                  {logo.sub}
                </span>
              </div>
            </div>
